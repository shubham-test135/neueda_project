...
function setupEventListeners() {
  ...
  if (sendEmailBtn) {
    // Listen for clicks on the Email Report button
...
function handlePreviewPDF() {
  ...
  const apiBaseUrl = `http://${hostname}:8081/api`;

  iframe.src = `${apiBaseUrl}/reports/portfolio/${currentPortfolioId}/pdf?mode=preview`;
